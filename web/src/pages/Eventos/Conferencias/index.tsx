...
const EventosConferencia = () => {
    ...
    return (
        <>
            ...
            <Titulo titulo={`Conferências`} voltar={`/`} />

            <Typography mb={3} variant='body1'>
                Nessa página serão listadas as conferências mais recentes cadastradas.
            </Typography>
...
export default EventosConferencia
